...
# in "%s"
changelog_render_ticket = "https://github.com/kreczko/ntuple/issues/%s"
changelog_render_pullreq = "https://github.com/kreczko/ntuple/pulls/%s"
changelog_render_changeset = "https://github.com/kreczko/ntuple/commit/%s"
